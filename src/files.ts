...
export const filesJSON = {
  './01-simple-example/script.ts': contract01_script_raw,
  './01-simple-example/contract.fc': contract01_contract_raw,
  './01-simple-example/stdlib.fc': contract01_stdlib_raw,
  './01-simple-example/mint-nft.ts': contract02_mintNft_raw,
};
